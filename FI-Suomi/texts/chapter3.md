...
Varmuuskopiosta salaisten sanojen palautus kestää vain muutamia minuutteja.

Muista aina, että sanojasi ei koskaan saa postittaa, ladata verkkoon, laittaa liitteeksi ja muutenkaan välittää verkossa. Älä kuvaa sanojasi, äläkä koskaan muutenkaan tallenna niitä missään muodossa sähköisesti tai digitaalisesti.

***

## VARMUUSKOPIOT

### Tarvitset turvallisen varmuuskopion, jotta varat ovat varmasti hallussasi
...
**ÄLÄ IKINÄ VALOKUVAA SALAISIA SANOJA!**

**Muista, valokuvia voidaan katsella ja käsitellä - jopa täysin luvatta!**

Kenelläkään muulla, kuin sinulla, ei ole ikinä mitään tarvetta tietää salaisia sanojasi. Samalla kun laitelompakko otetaan käyttöön, talletetaan sanasi lompakon salattuun muistiin. Niinpä sinulla on jo alussa paperilla varmuuskopio.

**Suojaa sanasi - luo pysyvä varmuuskopio, metalliin.**
...
## Valmistele kunnolliset työkalut

***

## VARMUUSKOPIOT - METALLINEN VARMUUSKOPIO
...
## Metalliin varmuuskopiointi

***

## VARMUUSKOPIOINTI - TESTAA VARMUUSKOPIO

Varmista varmuuskopiosi toiminta ennen kuin sitä oikeasti tarvitaan: joskus päivien, kuukausien tai vuosien jälkeen.

**ÄLÄ LUOTA, ETTÄ VARMUUSKOPIOSI ON ONNISTUNUT - TESTAA SE HETI**

Varmuuskopiointi prosessin viimeisenä vaiheena on varmistus, että myös palautus toimii sitten kun sitä joskus tarvitset.

### TESTAUS

- Siirrä pieni määrä varoja uudelle lompakollesi
- Palauta laitelompakkosi tehdasasetuksille
- Suorita kyseiselle laitteelle oheistettu palautusprosessi

Kun palautus prosessi on suoritettu ja sinulla on jälleen pääsy varoihisi, on testi onnistunut. Onneksi olkoon! Nyt sinulla on oikein tehty varmuuskopio. Sen avulla voit tulevaisuudessa palauttaa varat hallintaasi, milloin ikinä tarvetta tuleekaan.

**TÄRKEÄÄ!**

**VAIN TESTATTU VARMUUSKOPIO TAKAA PÄÄSYN VAROIHISI TULEVAISUUDESSA. JOS SALAISET SANAT OVAT VÄÄRIN VARMUUSKOPIOSSA, ON PALAUTUS MAHDOTONTA.**

***

## Testaa varmuuskopiosi